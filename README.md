...
<p align="center">
  <img src="docs/assets/pipeline.svg" alt="Processing Pipeline Workflow" width="100%">
</p>
...
<p align="center">
  <img src="docs/assets/case-study.svg" alt="Study Area Summary" width="100%">
</p>

- **Район исследования**: Приморский район Санкт-Петербурга
- **Площадь**: 109.87 км² (10 987 га)
- **Население**: ~714,854 жителей
- **Период мониторинга**: 2015 – 2025 гг. (сценарный прогноз на 2035 г.)
- **Источник данных**: Спутниковые снимки Sentinel-2 (уровень L2A, атмосферная коррекция BOA)
- **Целевое пространственное разрешение**: 10 м / пиксель (проекция `EPSG:32636`)
...
<p align="center">
  <img src="docs/assets/findings.svg" alt="Key Findings: Land Cover Distribution" width="100%">
</p>

### Шкала классов NDVI

| Класс | Интервал NDVI | Категория | Типичный покров | Площадь (га) | Доля (%) |
| :---: | :---: | :--- | :--- | :---: | :---: |
| **1** | $< 0.10$ | Водные объекты и открытый грунт | Акватории, карьеры, обнаженная почва | 381 га | 3.5% |
| **2** | $0.10 - 0.25$ | Искусственные покрытия / застройка | Плотная городская застройка, асфальт | 2 657 га | 24.1% |
| **3** | $0.25 - 0.45$ | Разреженная / нарушенная растительность | Газоны, нарушенные участки, пустыри | 3 124 га | 28.4% |
| **4** | $0.45 - 0.65$ | Умеренная растительность | Скверы, парки, придомовое озеленение | 4 458 га | 40.5% |
| **5** | $> 0.65$ | Плотный здоровый древостой | Лесопарковые массивы, ООПТ | 392 га | 3.5% |
